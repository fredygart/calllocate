...
var jsonDatas = (function(){return (validar == 1)?"https://cdn.jsdelivr.net/gh/fredygart/calllocatedata/i000-003.json":"https://cdn.jsdelivr.net/gh/fredygart/calllocatedata/e000-000.json";})();
...
function buildData(){
for(x in data){
demo.innerHTML += (function(){return (Number(this.data[x].fecha)<fechaActual)?"<li class='convx'>":"<li class='conv'><b>"})()+data[x].name+"</b><br>"+data[x].des+"<br>---<br>"+(function(){return (validar == 1)?"Subject: ":"Tema: ";})()+data[x].sub+"<br>"+(function(){return (validar == 1)?"Amount: <ins>":"Cantidad: <ins>";})()+data[x].amount+"</ins><br>"+(function(){return (validar == 1)?"Type: ":"Tipo: ";})()+data[x].typ+"<br>"+(function(){return (validar == 1)?"Origin: ":"Origen: ";})()+data[x].cty+"<br>"+"<a href='"+data[x].lnk+(function(){return (validar == 1)?"'>More information</a>":"'>Más información</a>";})()+"<br>"+(function(){return (validar == 1)?" Deadline: ":" Fecha límite: ";})()+(function(){return (Number(this.data[x].fecha)<fechaActual)?"<span class='del'>"+fFecha(this.data[x].fecha)+(function(){return (validar == 1)?" [expired]</span>":" [vencida]</span>";})():fFecha(this.data[x].fecha);})()+"</li>";
}
setTimeout(function() {
